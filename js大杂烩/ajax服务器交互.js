...
同步请求
XMLHttpRequest.status >= 200 && XMLHttpRequest.status < 300|| XMLHttpRequest.status == 304
异步请求
...
//实现ajax XMLHttpRequest对象
ajax({
    url: 'http://127.0.0.1:8080/xxx.do?username=testuser&userno=123',
    method: 'get',
    async: true,
    data: {
        test: 1,
...
function ajax(ajaxsetting) {
    ...
    return new Promise(function (resolve,reject) {
        ...
        if(ajaxsetting.method.toLocaleLowerCase() == 'get'){
            xhr.send(null);
        }else{
            xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");//模仿表单请求
